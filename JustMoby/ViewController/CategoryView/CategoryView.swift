...
class CategoryView: UIView {
    ...
    private func setupConstraints() {
        ...
        horizontalStackView.addArrangedSubview(seeAllLabel)
        ...
        let right = self.horizontalStackView.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -16)
    ...
    func setupNumber(forSection: Int) {
        titleLabel.text = "Category-\(forSection)"
    }
